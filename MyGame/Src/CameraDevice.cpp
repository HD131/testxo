...
{
	// провер€ем, находитс€ ли точка пересечени€ внутри треугольника.
	D3DXVECTOR3 a;
...
{	
	...
	{
		Triangle[0] = (CVertexFVF*)( pVertices + ( *pIndices++ ) );//точка ј i-того треугольника
		...
		// рассто€ние от камеры до точки столкновени€ 
